...
class JobseekersTable
{
    ...
    public function getUserDetails($userId){
       ...
       // $select->columns($jobseekersCols);
        ...
        $sqlString = "SELECT jobseekers.* , cj_ch_jobseekers_res_det.* from jobseekers join cj_ch_jobseekers_res_det on jobseekers.UserId = cj_ch_jobseekers_res_det.UserId  where jobseekers.Userid='".$userId."' group by (jobseekers.UserId) ";
